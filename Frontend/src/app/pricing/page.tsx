  ...
  const pricingItems = [
    {
      ...
      features: [
        {
          text: '1 diagram per AWS account',
          footnote:
            'The maximum amount of diagrams per AWS account.',
        },
        {
          text: 'Adjustable Diagrams',
          footnote:
            'Edit diagrams on the fly. Create new diagrams at any time.',
        },
        {
